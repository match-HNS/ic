...
项目从零开始独立开发，灵感来源于 CS 1.6 HNS 社区的各种玩法。在参考了社区内多个优秀项目的设计思路后，结合自身服务器运营需求，打造出了一套功能完善、模式丰富的比赛系统。代码架构完全自主设计，所有核心模块均为原创实现。

### 开发历程

| 时间 | 里程碑 |
|------|--------|
| 2024 Q1 | 项目启动，完成核心框架设计，实现基础 HNS 玩法 |
| 2024 Q2 | 重构统一菜单系统，支持 M 键 / 夜视仪快捷打开 |
| 2024 Q3 | 开发 AI 自动报名分组系统，实现全自动比赛组织流程 |
| 2024 Q4 | 开发皮肤系统、权限管理系统、管理员分级体系 |
| 2025 Q1 | 新增点位积分模式和吸血鬼模式，丰富比赛玩法 |
| 2025 Q2 | 新增回合制模式、投降系统、逃跑惩罚机制 |
| 2025 Q3 | 新增 RTV 投票换图、观战者投票系统 |
| 2025 Q4 | 开发独立积分系统，统计系统支持 MySQL |
| 2026 Q1 | 全面代码审计，修复关键缺陷，优化稳定性 |
| 2026 Q2 | v5.0.0 正式发布，品牌独立化 |
