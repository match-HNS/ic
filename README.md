...
项目始于 2024 年初，最初只是对 OpenHNS v4.2.0 的小幅修改和功能补丁。随着社区服务器的运营需求不断增长，逐渐演变为一个独立维护的大型插件系统。经过两年多的持续开发和迭代，GTRHNS 已经从最初的补丁集合发展为一个拥有 **9 种游戏模式、20+ 个配套插件、完整 AI 报名系统** 的成熟比赛平台。

### 开发历程

| 时间 | 里程碑 |
|------|--------|
| 2024 Q1 | 项目启动，基于 OpenHNS v4.2.0 进行功能补丁 |
| 2024 Q2 | 重构菜单系统，统一为 HnsIC 大菜单框架 |
| 2024 Q3 | 新增 AI 自动报名分组系统 |
| 2024 Q4 | 新增皮肤系统、权限管理系统 |
| 2025 Q1 | 新增点位积分/吸血模式（Ascension/Vampire） |
| 2025 Q2 | 新增回合制模式、投降系统、逃跑惩罚 |
| 2025 Q3 | 新增 RTV 投票、观战者投票系统 |
| 2025 Q4 | 独立积分系统、统计系统 MySQL 化 |
| 2026 Q1 | 全面 Bug 审计，修复 11 个关键缺陷 |
| 2026 Q2 | v5.0.0 正式发布，去除旧版标记，独立品牌化 |
...
- OpenHNS — 原始框架和部分插件基础代码
- Mistrick — Chatmanager 基础代码
- ReGameDLL / ReAPI 团队 — 提供底层 API 支持
- AMX Mod X 社区 — 持续维护的脚本引擎
